		    ...
		    <section id="project_detal_description">
		  	  ...
		  	  <div class="container-fluid">
		  		  <div class="container cf">
					  ...
					  <form method="post" action="project_apply_complete.php">
		  				  <div class="description_left">
		  					  ...
		  					  <div class="description_part">
		  						  <h2>提案</h2>
		  						  <div class="pall-0202020">
		  							<p><?php echo nl2br($apply_description); ?></p>
		  						  </div>
		  					  </div>
		  					  <div class="description_part">
		  						  <h2>希望報酬</h2>
		  						  <div class="pall-0202020">
		  							<p><?php echo $apply_money; ?></p>
		  						  </div>
		  					  </div>
		  					  <div class="description_part">
		  						  <h2>その他</h2>
		  						  <div class="pall-0202020">
		  							<p><?php echo $apply_other; ?></p>
		  						  </div>
		  					  </div>
						    </div>
	  ...
	  <div id="submit_footer" class="">
		  <div class="container">
			  <div class="col-xs-12">
				  <div class="pall-12">
					  <p class="text-center">
							<button type="button" onclick="history.back()" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span>戻　　る</button>
						 	 <?php
							if(isset($_POST['apply_submit'])){ ?>
							<button type="submit" name="apply_submit" id="apply_submit" class="btn btn-success btn-lg">提案する<span class="glyphicon glyphicon-chevron-right"></span></button>
								...
								<input type="hidden" name="apply_description" id="apply_description" value="<?php echo $apply_description; ?>">
								<input type="hidden" name="apply_money" id="apply_money" value="<?php echo $apply_money; ?>">
								<input type="hidden" name="apply_other" id="apply_other" value="<?php echo $apply_other; ?>">
								<input type="hidden" name="apply_name" id="apply_name" value="<?php echo $name; ?>">
							...
							<button type="submit" name="apply_reserve" id="apply_reserve" class="btn btn-success btn-lg">下書き保存する<span class="glyphicon glyphicon-chevron-right"></span></button>
								<input type="hidden" name="project_no" id="project_no" value="<?php echo $project_no; ?>">
								<input type="hidden" name="project_title" id="project_title" value="<?php echo $project_title; ?>">
								<input type="hidden" name="apply_description" id="apply_description" value="<?php echo $apply_description; ?>">
								<input type="hidden" name="apply_money" id="apply_money" value="<?php echo $apply_money; ?>">

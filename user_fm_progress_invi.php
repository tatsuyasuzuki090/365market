		    ...
		    <section id="user_config" class="clearfix">
			    <div class="container">
				    <div class="col-xs-12 col-sm-3 mb30">
					    <div class="pall-10">
						    <ul>
							    ...
							    <li><a href="user_fm_progress_invi.php#top" class="active">招待された案件<i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
				    ...
				    <div class="col-xs-12 col-sm-9">
					    <div class="pall-10">
						    <h2 id="top">招待された案件</h2>
						    <p class="caution"></p>
						    <form method="post">
						    <table class="user_apply_table">
			  					<tr>
			  						<th><a href="#">案件名案件名案件名案件名案件名案件名案件名案件名案件名案件名</a></th>
			  						<td><span class="label label-warning">決　　定</span></td>
			  					</tr>
			  					<tr>
			  						<th><a href="#">案件名案件名案件名案件名案件名案件名案件名案件名案件名案件名</a></th>
			  						<td><span class="label label-warning">決　　定</span></td>

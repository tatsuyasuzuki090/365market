...
$(document).ready(function () { 
	$('#save_thumb').click(function() {
		...
		var h = $('#h').val();
		if(x1=="" || y1=="" || x2=="" || y2=="" || w=="" || h==""){
			alert("画像の切り抜き範囲を指定してください。マウスでドラッグすると選択範囲が現れます。");
			return false;
		}else{
			return true;
		}
...
$(window).load(function () { 
	...
	$('#thumbnail').imgAreaSelect({ x1: 0, y1: 0, x2: 1200, y2: 400, onSelectChange: preview  }); 
});
...
if(strlen($large_photo_exists)>0 && strlen($thumb_photo_exists)>0){
	...
	echo "<p><a href=\"".$_SERVER["PHP_SELF"]."\">アップロードする</a></p>";
